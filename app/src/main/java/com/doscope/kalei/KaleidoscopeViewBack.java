 ...
 */
public class KaleidoscopeViewBack extends SurfaceView implements SurfaceHolder.Callback {
    private static final String LOGTAG = LogUtil.makeLogTag(KaleidoscopeViewBack.class);
    ...
    public KaleidoscopeViewBack(Context context) {
        super(context);
        init(context);
    }

    public KaleidoscopeViewBack(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public KaleidoscopeViewBack(Context context, AttributeSet attrs, int defStyleAttr) {
